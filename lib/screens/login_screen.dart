...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _showGoogleSignInModal() async {
    // Show PolicyBazaar style modal
    showDialog(
      context: context,
        ...
        content: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Continue to compare and buy insurance policies',
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.grey,
                ),
